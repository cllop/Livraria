...
public class RegistrosBDParaTesteFuncionalBD implements RegistrosBD{
	...
	public static ConteudoTabelaDB<Cliente> criarRegistrosCliente(){
		...
		clientes.add(new Cliente(++numeroDeUsuariosJaCadastrados, 2, 98573153332l, "Shinolino", "Soares", "Linoshino", "Lagland", "IsaiEoLag", "Alto da Perturba��o", "Carvalho", "Periculosidade", 46464646, (byte)57, (byte)55, (byte)71, 985859979));
		clientes.add(new Cliente(++numeroDeUsuariosJaCadastrados, 3, 11919554488l, "Sonyscleison", "Fernandes", "Brasil", "Estados Zunidos", "Matatatu de Brotas", "Eucalipto", "Ca�a da On�a", "Matador de Javalis", 45454545, (byte)56, (byte)1 , (byte)56, 965652287));
